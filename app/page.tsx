              ...
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 hover:scale-110 transition-transform duration-300">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="80" height="80" className="w-full h-full group" >
                    ...
                    <use href="#arc-tr" className="logo-theme" transform="translate(1,1)" />
                    <use href="#arc-tl" className="logo-theme" transform="translate(8.5,1)" />
                    <rect className="logo-theme logo-filler" x={16} y={1} width={7} height={7} rx={0.5} ry={0.5} />
                    <use href="#square" className="logo-theme" transform="translate(1,8.5)" />
                    <use href="#square" className="logo-theme" transform="translate(8.5,8.5)" />
                    <use href="#arc-br" className="logo-theme" transform="translate(16,8.5)" />
                    <rect className="logo-theme logo-filler" x={1} y={16} width={7} height={7} rx={0.5} ry={0.5} />
                    <use href="#square" className="logo-theme" transform="translate(8.5,16)" />
                    <use href="#arc-tr" className="logo-theme" transform="translate(16,16)" />
                  </svg>
                </div>
              </div>
